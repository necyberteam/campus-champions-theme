(function($) {
  ...
  $(document).scroll(function () {
   ...
   //console.log(target.style.backgroundPosition);
    var xvalue = '800px'; //target.style.backgroundPosition.split(' ')[0];//"90%";
    //console.log(xvalue);
    var factor = 0.5;
    //var yvalue = target.offsetHeight - (scrolltotop * factor); // + (target.offsetHeight * 0.3);
    var yvalue = (scrolltotop * factor) + 1000;
